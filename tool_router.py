...
def create_sublime_router() -> ToolRouter:
    ...
    router.register("terminal_run", lambda args: (
        ...
        f"return terminal_run({cmd_with_newline!r}, tag={args.get('tag')!r}, "
        f"wait={args.get('wait', 30)}, target_id={args.get('target_id')!r}, index={args.get('index')!r})"
    ...
    router.register("terminal_read", lambda args:
        ...
        f"target_id={args.get('target_id')!r}, index={args.get('index')!r})")
    ...
    router.register("terminal_close", lambda args:
        f"return terminal_close(tag={args.get('tag')!r}, target_id={args.get('target_id')!r}, index={args.get('index')!r})")
