...
Centralizes everything that varies between Claude / Codex / Copilot / DeepSeek / OpenAI:
...
@dataclass
class BackendSpec:
    name: str                                    # backend key
    label: str                                   # display label
    abbrev: str                                  # tab abbreviation ("" / "CX" / "CP" / "DS" / "OA")
    ...
    static_env: Dict[str, str] = field(default_factory=dict)  # always added via setdefault
    ...
    """Returns True if this backend can currently be used."""
